...
<!--CREATE-MODAL-->
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
	...
	<main>
		<div id="top-article">
			<?php echo "<img id='top-right-article' src='img/{$row['id']}.jpg'/>"?>
			<div id="top-left-article">
			<div id="button-article-div" onclick="history.back()">
				<div id="button-article"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M5 12h25" />
</svg>
</div></div>
				<span><span id="subt-article" >Naziv artikla:</span> <br><?php echo $row['naziv'];?></span>
				<div id="cijena-article"><?php echo $row['cijena'];?>KM</div>
			</div>
		</div>
		<div id="bottom-article">
			<div id="info-part-article">
				<div id="info-part-article1">
					Lokacija: <?php echo $row['lokacija'];?>
				</div>
				<div id="info-part-article2">
					Kategorija: <?php echo $row['kategorija'];?>
				</div>
				<div id="info-part-article1">
					Kontakt: <?php echo $row['kontakt'];?>
				</div>
				<div id="info-part-article3">
					Opis: <?php echo $row['opis'];?>
				</div>
				<div id="info-part-article1">
					Napravio: <?php echo $row['kreator'];?>
					<span style="float:right"><?php echo $row['datum-objave'];?></span>
				</div>
				<div id="info-part-article4">
